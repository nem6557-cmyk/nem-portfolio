  ...
  <div class="wrap nav-inner">
    <a class="brand" href="index.html" aria-label="Home">
      <svg class="glyph" viewBox="0 0 32 32" aria-hidden="true">
        <line x1="8" y1="12" x2="20" y2="12" stroke="#0F766E" stroke-width="2.4" stroke-linecap="round"/>
        <line x1="20" y1="12" x2="25" y2="22" stroke="#C2410C" stroke-width="2.4" stroke-linecap="round"/>
        <circle cx="8" cy="12" r="3" fill="#FFFFFF" stroke="#0F766E" stroke-width="2.4"/>
        <circle cx="20" cy="12" r="2.6" fill="#FFFFFF" stroke="#384B63" stroke-width="2.2"/>
        <circle cx="25" cy="22" r="2.6" fill="#C2410C"/>
      </svg>
      Nooruldeen Mustafa
    </a>

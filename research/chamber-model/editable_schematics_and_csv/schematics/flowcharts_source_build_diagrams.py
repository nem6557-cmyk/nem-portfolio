...
g.attr(dpi="160")
g.format="svg"; g.render("/home/claude/deliv/schematics/physics_model_map", cleanup=True)
g.format="pdf"; g.render("/home/claude/deliv/schematics/physics_model_map", cleanup=True)
...
n.attr(rankdir="TB", bgcolor="white", fontname="Helvetica", splines="spline",
       ...
       label=("Numerical study map  -  3D VOF + phase-change (OpenFOAM)\n"
              ...
              "amber = production-resolution step (not done)    red = honest status\n"))
...
n.node("CALIB", "Calibrate coeffC / coeffE  vs measured curve + CHF\n"
                ...
                "** production run -- NOT done **", fillcolor=FIT)
...
n.node("STATUS","STATUS:  unconverged DEMONSTRATION\n"
                ...
                "NOT validated -- needs refined mesh + calibration + convergence",
       fillcolor=STAT)
...
n.attr(dpi="160")
n.format="svg"; n.render("/home/claude/deliv/schematics/numerical_study_map", cleanup=True)
n.format="pdf"; n.render("/home/claude/deliv/schematics/numerical_study_map", cleanup=True)
